module github.com/UniquityVentures/lago/plugins/p_livereloading

go 1.26.1

require (
	github.com/UniquityVentures/lago/components v0.5.9
...
require (
	...
	github.com/UniquityVentures/lago/getters v0.5.9 // indirect
	github.com/UniquityVentures/lago/registry v0.5.9 // indirect
	github.com/UniquityVentures/lago/views v0.5.9 // indirect

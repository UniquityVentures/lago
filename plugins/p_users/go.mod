...
require (
	...
	github.com/UniquityVentures/lago/lago v0.3.0
...
require (
	...
	github.com/UniquityVentures/lago/fields v0.3.15 // indirect
	github.com/UniquityVentures/lago/registry v0.3.15 // indirect
